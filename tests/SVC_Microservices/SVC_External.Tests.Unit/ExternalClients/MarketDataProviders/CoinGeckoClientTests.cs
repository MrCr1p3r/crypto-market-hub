...
public class CoinGeckoClientTests
{
    ...
    public async Task GetCoinsList_ReturnsSuccessfulResultWithExpectedDataInside()
    {
        ...
        _httpMessageHandlerMock
            ...
            .ReturnsJsonResponse(HttpStatusCode.OK, TestData.CoinsListResponse);
    ...
    public async Task GetSymbolToIdMapForExchange_ReturnsExpectedData()
    {
        ...
        _httpMessageHandlerMock
            ...
            .ReturnsJsonResponse(HttpStatusCode.OK, TestData.ExchangeTickersPage1Response);
    ...
    public async Task GetSymbolToIdMapForExchange_EmptyResponseOnFirstPage_ReturnsEmptyDictionary()
    {
        ...
        _httpMessageHandlerMock
            .SetupRequest(HttpMethod.Get, $"https://api.coingecko.com{endpoint}")
            .ReturnsJsonResponse(HttpStatusCode.OK, emptyResponse);
    ...
    public async Task GetMarketDataForCoins_ReturnsExpectedData()
    {
        ...
        var endpoint =
            "/api/v3/coins/markets?vs_currency=usd&per_page=250&sparkline=false&ids=bitcoin,ethereum,solana";

        _httpMessageHandlerMock
            .SetupRequest(HttpMethod.Get, $"https://api.coingecko.com{endpoint}")
            .ReturnsJsonResponse(HttpStatusCode.OK, TestData.CoinsMarkets);
    ...
    public async Task GetMarketDataForCoins_ErrorResponse_ReturnsFailedResult()
    {
        ...
        var endpoint =
            "/api/v3/coins/markets?vs_currency=usd&per_page=250&sparkline=false&ids=bitcoin,ethereum";
    ...
    public async Task GetMarketDataForCoins_MoreThanMaxIdsPerRequest_MakesMultipleRequests()
    {
        ...
        var firstEndpoint =
            $"/api/v3/coins/markets?vs_currency=usd&per_page=250&sparkline=false&ids={firstChunkIds}";

        // Second chunk (50 ids)
        var secondChunkIds = string.Join(",", largeIds.Skip(250));
        var secondEndpoint =
            $"/api/v3/coins/markets?vs_currency=usd&per_page=250&sparkline=false&ids={secondChunkIds}";
        ...
        _httpMessageHandlerMock
            ...
            .ReturnsJsonResponse(HttpStatusCode.OK, sampleAssets);
    ...
    public async Task GetStablecoinsIds_ReturnsExpectedData()
    {
        ...
        _httpMessageHandlerMock
            ...
            .ReturnsJsonResponse(HttpStatusCode.OK, page1Response);

        _httpMessageHandlerMock
            .SetupRequest(HttpMethod.Get, $"https://api.coingecko.com{endpoint2}")
            .ReturnsJsonResponse(HttpStatusCode.OK, page2Response);
